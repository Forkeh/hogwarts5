...
public class StudentService {
    ...
    public Optional<StudentResponseDTO> partialUpdate(int id, StudentRequestDTO student) {
        ...
        if (existingStudent.isPresent()) {
            ...
            if (student.house() != null) {
                studentToUpdate.setHouse(houseService.findById(student.house())
                        .orElseThrow());
            }
    ...
    public Optional<StudentResponseDTO> deleteById(int id) {
        Optional<StudentResponseDTO> existingStudent = studentRepository.findById(id)
                .map(this::toDTO);
    ...
    private Student fromDTO(StudentRequestDTO studentDTO) {
        Student entity = new Student(
                ...
                studentDTO.lastName(),
                houseService.findById(studentDTO.house())
                        .orElseThrow(),
